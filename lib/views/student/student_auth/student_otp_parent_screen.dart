...
class StudentVerifyOTPScreen extends StatelessWidget {
  const StudentVerifyOTPScreen({Key? key}) : super(key: key);
              ...
              children: [
                  ...
                  child: Center(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return OTPFormField(
                            controller: index == 0
                                ? _studentSignUpController.otp1
                                : index == 1
                                    ? _studentSignUpController.otp2
                                    : index == 2
                                        ? _studentSignUpController.otp3
                                        : index == 3
                                            ? _studentSignUpController.otp4
                                            : index == 4
                                                ? _studentSignUpController.otp5
                                                : _studentSignUpController.otp6,
                          );
                        }),
                  ),
                ),
                ...
                ButtonWidget(
                  ...
                  onPressed: () async {
                    ...
                    _studentSignUpController.otp1.text == "" ||
                            _studentSignUpController.otp2.text == "" ||
                            _studentSignUpController.otp3.text == "" ||
                            _studentSignUpController.otp4.text == "" ||
                            _studentSignUpController.otp5.text == "" ||
                            _studentSignUpController.otp6.text == ""
                        ? AppWidgets.showSnackBar(context,
                            "Please fill the otp sent to your provided number.")
                        : await _studentSignUpController
                            .parentOTPVerify(context);
                  },
